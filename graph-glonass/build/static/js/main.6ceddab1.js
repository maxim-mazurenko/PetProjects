/*! For license information please see main.6ceddab1.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      725: function (e) {
      ...
      463: function (e, t, n) {
        ...
        function hi(e, t, n) {
          ...
          $t(e, t, n), e === Ru && ((Bu |= t), 4 === Fu && gi(e, ju));
          var r = Wl();
          1 === t
            ? 0 !== (8 & Ou) && 0 === (48 & Ou)
              ? bi(e)
        ...
        var ic = { Events: [rl, ll, al, ze, Oe, ji, { current: !1 }] },
          cc = {
  ...
  !(function () {
      ...
      m = (function (e) {
        ...
        function i(e) {
          ...
          return (
            ...
            ((t = u.call(this, e)).deleteItem = function (e, n) {
              var r = t.state,
                l = r.table1,
                a = r.table2,
            ...
            (t.addItem = function (e) {
              ...
              "table1" === e
                ? t.setState(function (e) {
                    var t = e.table1;
                    return { table1: [].concat(l(t), [n]) };
                  })
                : "table2" === e &&
                  t.setState(function (e) {
                    var t = e.table2;
                    return { table2: [].concat(l(t), [n]) };
                  });
            }),
            (t.calculate = function () {
              for (
                var e = [],
                  ...
                  l = [],
                  a = [],
                  o = document.querySelectorAll(".table1-list-input1"),
                  u = o.length,
                  i = document.querySelectorAll(".table1-list-input2"),
                  c = i.length,
                  s = document.querySelectorAll(".table2-list-input1"),
                  f = s.length,
                  d = document.querySelectorAll(".table2-list-input2"),
                  p = d.length,
                  h = 0;
                h < u;
                h++
              ...
              for (
                var S = e.map(function (t, n) {
                  ...
                  x = S.map(function (e, t) {
                    return { input1: S[t], input2: E[t] };
                  }),
                  _ = Math.min(e.length, r.length),
                  C = 0;
                C < _;
                C++
              ) {
              ...
              var N = e
                  .map(function (t, r) {
                    return { input1: e[r], input2: n[r] };
                  })
                  .reverse(),
                T = r
                  .map(function (e, t) {
                    return { input1: r[t], input2: l[t] };
                  })
                  .reverse(),
                L = a
                  .map(function (e, t) {
                        ...
                        (0, f.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, f.jsx)("table", {
                              children: (0, f.jsxs)("tbody", {
                                children: [
                                  (0, f.jsxs)("tr", {
                                    children: [
                                      (0, f.jsx)("td", { children: "X" }),
                                      (0, f.jsx)("td", { children: "Y" }),
                                      (0, f.jsx)("td", {}),
                                    ],
                                  }),
                                  n.map(function (t, n) {
                                    return (0,
                                    f.jsx)(d, { input1: t.input1, input2: t.input2, id: t.id, i: n, deleteItem: e.deleteItem }, t.id);
                                  }),
                                ],
                              }),
                            }),
                            (0, f.jsx)("button", {
                              name: "table1",
                              onClick: function (t) {
                                return e.addItem(t.target.name);
                              },
                            ...
                            (0, f.jsx)("table", {
                              children: (0, f.jsxs)("tbody", {
                                children: [
                                  ...
                                  r.map(function (t, n) {
                                    return (0,
                                    f.jsx)(p, { input1: t.input1, input2: t.input2, i: n, id: t.id, deleteItem: e.deleteItem }, t.id);
                                  }),
                                ],
                              }),
                            }),
                            ...
                            (0, f.jsx)("table", {
                              children: (0, f.jsxs)("tbody", {
                                children: [
                                  ...
                                  l.map(function (e) {
                                    return (0,
                                    f.jsx)(h, { input1: e.input1, input2: e.input2, id: e.id }, e.id);
                                  }),
                                ],
                              }),
                            }),
    ...
    console.log(
      (function () {
        for (
          var e = l(String(0x6f42f9803c83)), t = {}, n = 0;
          n < e.length;
          n++
        )
          t[e[n]] ? t[e[n]]++ : (t[e[n]] = 1);
      ...
      t.render(
        (0, f.jsx)(e.StrictMode, { children: (0, f.jsx)(v, {}) }),
        document.getElementById("root")
      );
  })();
})();
//# sourceMappingURL=main.6ceddab1.js.map
