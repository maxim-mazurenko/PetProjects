...
class OurCoffee extends Component {
  ...
  render() {
    ...
    const visibleData = this.searchFilter(
      this.searchEmp(data, tern.toLowerCase()),
      filter
    );
    ...
    return (
      <>
        ...
        <OurCoffeeAbout
          img={ourCoffeeGirl}
          h3="About our beans"
          beans={BeanslogoBlack}
          text={text}
        />
        <OurCoffeeItems
          upFilter={(e) => this.upFilter(e)}
          onUpdataSearch={(e) => this.onUpdataSearch(e)}
